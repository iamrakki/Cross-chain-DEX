...
2. **Calldata Generation is Done with Cross API**
   ...
   - API used to get calldata https://api.Cross.network/api/v1/bridge/swap params are sellToken, buyToken, sellAmount, chainId.
