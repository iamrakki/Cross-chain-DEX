# Cross Lock and Release Contract

## Overview
This smart contract is part of Cross DEX, a product by CrossNetwork on the Stellar blockchain. The contract implements a secure lock and release mechanism for cross-chain transactions.
